    ...
    return (
      ...
      >
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Welcome to DAxGENAI!</h2>
    ...
    >
      <div className="bg-white rounded-3xl shadow-2xl p-8 border border-gray-100 w-full max-w-md mx-auto transform transition-all duration-300 hover:shadow-3xl">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Join DAxGENAI</h2>
        ...
        <div className="mt-6">
          ...
          <button
            ...
            className="mt-4 w-full bg-white border border-gray-300 text-gray-700 py-3 px-4 rounded-lg font-medium hover:bg-gray-50 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
          >
            {isGoogleLoading ? (
              <Loader2 className="animate-spin" size={20} />
            ) : (
